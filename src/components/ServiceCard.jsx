...
const ServiceCard = ({imgURL,label,subtext}) => {
  return (
    <div className="flex-1 sm:w-[350px] sm:min-[350px] w-full rounded-[20px] shadow-3xl px-10 py-16 ">
        ...
        <h3  className="mt-5 font font-palanquin text-3xl leading-normal font-bold  ">
            {label}
        </h3>
        <p className="mt-3 breal-words font-montserrat text-lg leading-normal text-slate-gray ">
            {subtext}
        </p>
